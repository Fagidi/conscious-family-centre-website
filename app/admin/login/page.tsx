        ...
        <form onSubmit={handleSubmit} className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="you@consciousfamilycentre.com"
            />
          </div>
          ...
          <button
            ...
            className="w-full rounded-lg bg-forest-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-forest-700 disabled:opacity-50 transition-colors"
          >
